...
::: {layout-ncol=2}
![Mobius with the new UI widgets added](images/mobius-initial.png){.lightbox}

![Mobius with Mute Mode active](images/mobius-mutemode.png){.lightbox}
:::

::: {layout-ncol=3}
![Mobius with Menu A active](images/mobius-functionmode-menuA.png){.lightbox}

![Mobius with Menu B active](images/mobius-functionmode-menuB.png){.lightbox}

![Mobius with Tempo Tap Mode active](images/mobius-functionmode-TapMode.png){.lightbox}
:::

## Installation Steps

1. Copy the msl scripts to the `scripts` folder.
2. Open mobius and go to Display -> Edit Layouts... -> Floating Track Strip
  i. Drag MuteModeLabel, MuteModeLight, fmodeLabel, fmodeLight, fmenuALabel, fmenuBLabel and fmenuTapLabel from the right panel to the left panel.
